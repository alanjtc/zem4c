class ZCL_EM4C_XML_SD_ND_GENERATOR definition
  public
...
CLASS ZCL_EM4C_XML_SD_ND_GENERATOR IMPLEMENTATION.
...
*    concatenate is_data-invoice-s_vbrk-fkdat+6(2) '-' is_data-invoice-s_vbrk-fkdat+4(2) '-' is_data-invoice-s_vbrk-fkdat+0(4) into rs_data-fechancfmodificado.
  ...
  method PROCESS_DATA.
    ...
    append value #( field = zem4c_c_fields-hdr-clase_doc_fte value = 'SD_ND' ) to ct_data.
